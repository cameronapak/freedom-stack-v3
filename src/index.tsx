      ...
      <section data-signals:content="''" class="flex flex-col gap-4 grow p-6">
        ...
        <div id="posts-container">
          {posts && posts.length > 0 ? (
            ...
            <div id="empty-state" class="flex min-w-0 flex-1 flex-col items-center justify-center gap-6 rounded-lg border-dashed p-6 text-center text-balance md:p-12 text-neutral-800 dark:text-neutral-300">
