...
- [Semantics UI](https://github.com/cameronapak/semantics-ui) - Shadcn UI styles by default via a semantic CSS UI library, created by the maker of Freedom Stack
...
```bash
bun run seed # There will be issues seeding in code mode in bknd <= v0.20.0
```
